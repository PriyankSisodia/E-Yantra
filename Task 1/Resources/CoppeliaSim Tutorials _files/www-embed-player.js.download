...
function ra(a,b){a.j={za:b,Xa:!0};a.h=a.l||a.D}
...
function ya(a){for(;a.h.h;)try{var b=a.i(a.h);if(b)return a.h.o=!1,{value:b.value,done:!1}}catch(c){a.h.m=void 0,ra(a.h,c)}a.h.o=!1;if(a.h.j){b=a.h.j;a.h.j=null;if(b.Xa)throw b.za;return{value:b["return"],done:!0}}return{value:void 0,done:!0}}
...
c.prototype=b.prototype;a.H=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.yk=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
b;return a}
function id(a,b){b||(b={});b[kd(a)]=!0;var c=a.stack||"",d=a.zk;d&&!b[kd(d)]&&(c+="\nCaused by: ",d.stack&&0==d.stack.indexOf(d.toString())||(c+="string"===typeof d?d:d.message+"\n"),c+=id(d,b));return c}
...
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Hk;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Aa}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);this.h.cookie=a+"="+b+(f?";domain="+f:"")+(g?";path="+g:"")+(0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString())+(d?";secure":"")+(null!=e?";samesite="+e:"")};
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,n;a();return{reset:a,update:c,digest:d,Ja:function(){for(var p=d(),q="",r=0;r<p.length;r++)q+="0123456789ABCDEF".charAt(Math.floor(p[r]/16))+"0123456789ABCDEF".charAt(p[r]%16);return q}}}
...
function sd(a){var b=pd();b.update(a);return b.Ja().toLowerCase()}
...
function hh(a,b){if("log_event"===a.endpoint){var c="";a.C&&(gh[a.C.token]=ih(a.C),c=a.C.token);var d=fh.get(c)||[];fh.set(c,d);d.push(a.payload);b&&(ah=new b);c=Ef("web_logging_max_batch")||100;var e=R();d.length>=c?jh(!0):10<=e-dh&&(kh(),dh=e)}}
function lh(a,b){if("log_event"===a.endpoint){var c="";a.C&&(gh[a.C.token]=ih(a.C),c=a.C.token);var d=new Map;d.set(c,[a.payload]);b&&(ah=new b);return new M(function(e){ah&&ah.isReady()?mh(d,e,!1):e()})}}
function jh(a){a=void 0===a?!1:a;return new M(function(b){Pf(bh);Pf(ch);ch=0;ah&&ah.isReady()?(mh(fh,b,a),fh.clear()):(kh(),b())})}
function kh(){P("web_gel_timeout_cap")&&!ch&&(ch=Q(jh,6E4));Pf(bh);var a=H("LOGGING_BATCH_TIMEOUT",Ef("web_gel_debounce_ms",1E4));P("shorten_initial_gel_batch_timeout")&&eh&&(a=Xg);bh=Q(function(){jh(!0)},a)}
function mh(a,b,c){var d=ah;c=void 0===c?!1:c;var e=Math.round(R()),f=a.size;a=u(a);for(var g=a.next();!g.done;g=a.next()){var h=u(g.value);g=h.next().value;var k=h.next().value;h=nb({context:nh(d.h||oh())});h.events=k;(k=gh[g])&&ph(h,g,k);delete gh[g];qh(h,e);P("send_beacon_before_gel")&&window.navigator&&window.navigator.sendBeacon&&!c&&Lg("/generate_204");rh(d,"log_event",h,{retry:!0,onSuccess:function(){f--;f||b();$g=Math.round(R()-e)},
...
;var sh=w.ytLoggingGelSequenceIdObj_||{};x("ytLoggingGelSequenceIdObj_",sh,void 0);function th(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||R());e[a]=b;a=$f();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};P("log_sequence_info_on_gel_web")&&d.M&&(a=e.context,b=d.M,sh[b]=b in sh?sh[b]+1:0,a.sequence={index:sh[b],groupKey:b},d.Ka&&delete sh[d.M]);(d.Ik?lh:hh)({endpoint:"log_event",payload:e,C:d.C},c)}
...
function oh(){return{innertubeApiKey:H("INNERTUBE_API_KEY",void 0),innertubeApiVersion:H("INNERTUBE_API_VERSION",void 0),Qa:H("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Ra:H("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:H("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),Ta:H("INNERTUBE_CONTEXT_HL",void 0),Sa:H("INNERTUBE_CONTEXT_GL",void 0),Ua:H("INNERTUBE_HOST_OVERRIDE",void 0)||"",Wa:!!H("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),Va:!!H("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:H("SERIALIZED_CLIENT_CONFIG_DATA",void 0)}}
function nh(a){var b={client:{hl:a.Ta,gl:a.Sa,clientName:a.Ra,clientVersion:a.innertubeContextClientVersion,configInfo:a.Qa}},c=window.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=H("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=[];var d=H("EXPERIMENTS_FORCED_FLAGS",{});for(e in d)c.push({key:e,value:String(d[e])});var e=H("EXPERIMENT_FLAGS",{});for(var f in e)f.startsWith("force_")&&void 0===d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});
a.appInstallData&&P("web_log_app_install_experiments")&&(b.client.configInfo=b.client.configInfo||{},b.client.configInfo.appInstallData=a.appInstallData);H("DELEGATED_SESSION_ID")&&!P("pageid_as_header_web")&&(b.user={onBehalfOfUser:H("DELEGATED_SESSION_ID")});if(P("web_log_connection_in_gel")){a:{if(f=(a=w.navigator)?a.connection:void 0){a=zh[f.type||"unknown"]||"CONN_UNKNOWN";f=zh[f.effectiveType||"unknown"]||"CONN_UNKNOWN";"CONN_CELLULAR_UNKNOWN"===a&&"CONN_UNKNOWN"!==f&&(a=f);if("CONN_UNKNOWN"!==
...
function Bh(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||H("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.xk||H("AUTHORIZATION"))||(a?b="Bearer "+y("gapi.auth.getToken")().wk:b=wd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=H("SESSION_INDEX",0),P("pageid_as_header_web")&&(d["X-Goog-PageId"]=H("DELEGATED_SESSION_ID")));return d}
...
"Can't start a transaction on a closed database",Zh),ai={},bi=(ai.AUTH_INVALID="ERROR",ai.EXECUTE_TRANSACTION_ON_CLOSED_DB="WARNING",ai.EXPLICIT_ABORT="IGNORED",ai.IDB_NOT_SUPPORTED="WARNING",ai.MISSING_OBJECT_STORE="ERROR",ai.QUOTA_EXCEEDED="WARNING",ai.QUOTA_MAYBE_EXCEEDED="WARNING",ai.UNKNOWN_ABORT="WARNING",ai);
...
v(U,T);function ci(a){U.call(this,"MISSING_OBJECT_STORE",{Dk:a},$h.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,ci.prototype)}
...
dbName:b});Object.setPrototypeOf(a,T.prototype);a.args=[{name:"IdbError",Ek:a.name,dbName:b,objectStoreNames:c}];return a}
...
closed:b,qb:b,upgrade:a.options.upgrade},d=function(){return bc(a,function g(){var h=this,k,l,n;return Aa(g,function(p){switch(p.h){case 1:return p.l=2,sa(p,Gi(h.name,h.options.version,c),4);case 4:k=p.m;if(!tc){p.h=5;break}a:{var q=u(Object.keys(h.options.Za));for(var r=q.next();!r.done;r=q.next())if(r=r.value,!k.h.objectStoreNames.contains(r)){q=r;break a}q=void 0}l=q;if(void 0===l){p.h=5;break}if(!tc||h.i){p.h=7;break}h.i=!0;return sa(p,h["delete"](),8);case 8:return p["return"](d());case 7:throw new ci(l);
...
;var Ii=new Fi({Za:{databases:!0},upgrade:function(a,b){1>b&&a.h.createObjectStore("databases",{keyPath:"actualName"})}});
...
2;d={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0,signedIn:!1};return sa(e,Ji(d),4);case 4:return sa(e,Ki(),5);case 5:return e["return"](!0);case 2:return ta(e),e["return"](!1)}})})}
...
;function Vi(a){a=void 0===a?{}:a;Ce.call(this);var b=this;this.l=this.u=0;Qi.h||(Qi.h=new Qi);this.j=Qi.h;this.j.j=!0;a.Ya&&(this.j.o=!0);a.ja?(this.ja=a.ja,te(this.j,"ytnetworkstatus-online",function(){Wi(b,"publicytnetworkstatus-online")}),te(this.j,"ytnetworkstatus-offline",function(){Wi(b,"publicytnetworkstatus-offline")})):(te(this.j,"ytnetworkstatus-online",function(){De(b,"publicytnetworkstatus-online")}),te(this.j,"ytnetworkstatus-offline",function(){De(b,"publicytnetworkstatus-offline")}))}
v(Vi,Ce);function Wi(a,b){a.ja?a.l?(Vf(a.u),a.u=Sf(function(){a.o!==b&&(De(a,b),a.o=b,a.l=R())},a.ja-(R()-a.l))):(De(a,b),a.o=b,a.l=R()):De(a,b)}
;var Xi;function Yi(a,b){b=void 0===b?{}:b;Ni().then(function(){Xi||(Xi=new Vi({Ya:!0}));Xi.j.l!==Ri()&&Af(new T("NetworkStatusManager isOnline does not match window status"));yg(a,b)})}
...
timeout:d.timeout,withCredentials:!0},g="";(e=a.h.Ua)&&(g=e);var h=a.h.Wa||!1,k=Bh(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.h.innertubeApiVersion+"/"+b;var l={alt:"json"};a.h.Va&&f.headers.Authorization||(l.key=a.h.innertubeApiKey);var n=kg(""+g+e,l||{},!0);Ni().then(function(p){if(d.retry&&P("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=g){if(P("networkless_gel")&&!p||!P("networkless_gel"))var q=Gh(b,
c,k,h);if(q){var r=f.onSuccess,z=f.onFetchSuccess;f.onSuccess=function(A,D){Hh(q);r(A,D)};
c.onFetchSuccess=function(A,D){Hh(q);z(A,D)}}}try{P("use_fetch_for_op_xhr")?vg(n,f):P("networkless_gel")&&d.retry?(f.method="POST",!d.rb&&P("nwl_send_fast_on_unload")?Zi(n,f):Yi(n,f)):(f.method="POST",f.postParams||(f.postParams={}),yg(n,f))}catch(A){if("InvalidAccessError"==A.name)q&&(Hh(q),q=0),Af(Error("An extension is blocking network request."));
...
a.level)a=0;else a:{a=dj();c=u(a.i);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Ck)){a=d.weight;break a}a=u(a.h);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ia(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(aj);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.sa[l.name])for(e=u(c.sa[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+
e[g]]=d[g+1];l.message=c.Ba(f);break}l.params||(l.params={});a=dj();l.params["params.errorServiceSignature"]="msg="+a.i.length+"&cb="+a.h.length;l.params["params.serviceWorker"]="false";l.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length);window.yterr&&"function"===typeof window.yterr&&window.yterr(l);a=0===l.sampleWeight;if(!kj.has(l.message)&&!a){"ERROR"===b?(ej.O("handleError",l),P("record_app_crashed_web")&&0===nj&&1===l.sampleWeight&&(nj++,X("appCrashed",
{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),mj++):"WARNING"===b&&ej.O("handleWarning",l);if(P("kevlar_gel_error_routing")){c=b;a:{a=u(pj);for(d=a.next();!d.done;d=a.next())if(Fg(d.value.toLowerCase())){a=!0;break a}a=!1}if(!a){d={stackTrace:l.stack};l.fileName&&(d.filename=l.fileName);a=l.lineNumber&&l.lineNumber.split?l.lineNumber.split(":"):[];0!==a.length&&(1!==a.length||isNaN(Number(a[0]))?2!==a.length||isNaN(Number(a[0]))||isNaN(Number(a[1]))||(d.lineNumber=Number(a[0]),d.columnNumber=Number(a[1])):
...
kh:26108,lh:26109,mh:26110,nh:66881,oh:28236,ph:14586,qh:57929,rh:74723,sh:44098,uh:44099,vh:23528,wh:61699,xh:59149,yh:101951,zh:97346,Ah:118051,Bh:95102,Ch:64882,Dh:119505,Eh:63595,Fh:63349,Gh:95101,Hh:75240,Ih:27039,Jh:68823,Kh:21537,Lh:83464,Mh:75707,Nh:83113,Oh:101952,Ph:101953,Rh:79610,Sh:24402,Th:24400,Uh:32925,Vh:57173,Wh:64423,Xh:64424,Yh:33986,Zh:100828,ai:21409,bi:11070,ci:11074,di:17880,fi:14001,hi:30709,ii:30707,ji:30711,ki:30710,li:30708,gi:26984,mi:63648,ni:63649,oi:51879,ri:111059,
si:5754,ti:20445,vi:110386,wi:113746,xi:66557,yi:17310,zi:28631,Ai:21589,Bi:68012,Ci:60480,Di:31571,Ei:76980,Fi:41577,Gi:45469,Hi:38669,Ii:13768,Ji:13777,Ki:62985,Mi:59369,Ni:43927,Oi:43928,Pi:12924,Qi:100355,Si:56219,Ti:27669,Ui:10337,Ri:47896,Vi:107598,Wi:96639,Xi:107536,Yi:96661,Zi:96658,aj:116646,bj:96660,cj:104443,dj:96659,ej:106442,fj:63667,gj:63668,hj:63669,ij:78314,jj:55761,kj:96368,lj:67374,mj:48992,nj:49956,oj:31961,pj:26388,qj:23811,rj:5E4,tj:47355,uj:47356,vj:37935,wj:45521,xj:21760,yj:83769,
zj:49977,Aj:49974,Bj:93497,Cj:93498,Dj:34325,Ej:115803,Fj:100081,Gj:35309,Hj:68314,Ij:25602,Jj:100339,Kj:59018,Lj:18248,Mj:50625,Nj:9729,Oj:37168,Pj:37169,Qj:21667,Rj:16749,Sj:18635,Tj:39305,Uj:18046,Vj:53969,Wj:8213,Xj:93926,Yj:102852,Zj:110099,ak:22678,bk:69076,dk:100856,ek:17736,fk:3832,gk:55759,hk:64031,ik:93044,jk:93045,kk:34388,lk:17657,mk:17655,nk:39579,pk:39578,qk:77448,rk:8196,sk:11357,tk:69877,uk:8197,vk:82039};function Qj(a){a=void 0===a?!1:a;L.call(this);this.h=new N(a);Rc(this,Sa(Pc,this.h))}
...
Rj.prototype.A=function(){this.destination=this.j=null;Qj.prototype.A.call(this)};function Sj(a){L.call(this);this.h=a;this.h.subscribe("command",this.Ca,this);this.j={};this.m=!1}
...
m.Ca=function(a,b,c){if(this.m&&!this.i){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&(a=d.event,a in this.j||(c=C(this.jb,this,a),this.j[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":"string"===typeof d.event&&Tj(this,d.event);break;default:this.l.isReady()&&this.l.isExternalMethodAvailable(a,c||null)&&(b=Uj(a,b||{}),c=this.l.handleExternalCall(a,b,c||null),(c=Vj(a,c))&&this.P(a,c))}}};
m.jb=function(a,b){this.m&&!this.i&&this.h.P(a,this.na(a,b))};
m.na=function(a,b){if(null!=b)return{value:b}};
function Tj(a,b){b in a.j&&(a.removeEventListener(b,a.j[b]),delete a.j[b])}
m.A=function(){var a=this.h;a.i||cf(a.h,"command",this.Ca,this);this.h=null;for(var b in this.j)Tj(this,b);L.prototype.A.call(this)};function Wj(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
bk.prototype.A=function(){window.removeEventListener("message",this.u);L.prototype.A.call(this)};function ck(){var a=this.i=new bk(!!H("WIDGET_ID_ENFORCE")),b=C(this.gb,this);a.m=b;a.o=null;this.i.channel="widget";if(a=H("WIDGET_ID"))this.i.sessionId=a;this.l=[];this.o=!1;this.m={}}
m=ck.prototype;m.gb=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.m[a]||"onReady"==a||(this.addEventListener(a,dk(this,a)),this.m[a]=!0)):this.ta(a,b,c)};
m.ta=function(){};
function dk(a,b){return C(function(c){this.sendMessage(b,c)},a)}
m.addEventListener=function(){};
m.La=function(){this.o=!0;this.sendMessage("initialDelivery",this.oa());this.sendMessage("onReady");G(this.l,this.Da,this);this.l=[]};
m.oa=function(){return null};
function ek(a,b){a.sendMessage("infoDelivery",b)}
m.Da=function(a){this.o?this.i.sendMessage(a):this.l.push(a)};
m.sendMessage=function(a,b){this.Da({event:a,info:void 0==b?null:b})};
m.dispose=function(){this.i=null};function fk(a){ck.call(this);this.h=a;this.j=[];this.addEventListener("onReady",C(this.cb,this));this.addEventListener("onVideoProgress",C(this.nb,this));this.addEventListener("onVolumeChange",C(this.ob,this));this.addEventListener("onApiChange",C(this.ib,this));this.addEventListener("onPlaybackQualityChange",C(this.kb,this));this.addEventListener("onPlaybackRateChange",C(this.lb,this));this.addEventListener("onStateChange",C(this.mb,this));this.addEventListener("onWebglSettingsChanged",C(this.pb,
this))}
...
m.cb=function(){var a=C(this.La,this);this.i.h=a};
...
m.kb=function(a){ek(this,{playbackQuality:a})};
m.lb=function(a){ek(this,{playbackRate:a})};
m.ib=function(){for(var a=this.h.getOptions(),b={namespaces:a},c=0,d=a.length;c<d;c++){var e=a[c],f=this.h.getOptions(e);b[e]={options:f};for(var g=0,h=f.length;g<h;g++){var k=f[g],l=this.h.getOption(e,k);b[e][k]=l}}this.sendMessage("apiInfoDelivery",b)};
m.ob=function(){ek(this,{muted:this.h.isMuted(),volume:this.h.getVolume()})};
m.nb=function(a){a={currentTime:a,videoBytesLoaded:this.h.getVideoBytesLoaded(),videoLoadedFraction:this.h.getVideoLoadedFraction(),currentTimeLastUpdated_:E()/1E3,playbackRate:this.h.getPlaybackRate(),mediaReferenceTime:this.h.getMediaReferenceTime()};this.h.getProgressState&&(a.progressState=this.h.getProgressState());ek(this,a)};
m.pb=function(){var a={sphericalProperties:this.h.getSphericalProperties()};ek(this,a)};
...
return a.join("")}
;var xk=w.ytLoggingDocDocumentNonce_||wk();x("ytLoggingDocDocumentNonce_",xk,void 0);var yk={Zd:0,ac:1,kc:2,dh:3,ae:4,ck:5,Qh:6,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS"};function zk(a){this.h=a}
...
x("yt_logging_screen.getCttAuthInfo",Ik,void 0);function Jk(a,b,c,d){c=void 0===c?0:c;if(a!==H(Bk(c))||b!==H(Ck(c)))if(Hk(a,d,c),O(Bk(c),a),O(Ck(c),b),0==c||P("web_screen_associated_all_layers"))b=function(){setTimeout(function(){a&&th("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:xk,clientScreenNonce:a},$i)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
...
v(Hl,L);Hl.prototype.A=function(){for(;this.h.length;){var a=this.h.pop();a.target.removeEventListener(a.name,a.Ia)}L.prototype.A.call(this)};function Il(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||mb(b);this.assets=a.assets||{};this.attrs=a.attrs||mb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
...
;function Ol(a,b,c,d){L.call(this);var e=this;this.u=this.da=a;this.J=b;this.B=!1;this.api={};this.ba=this.I=null;this.K=new N;Rc(this,Sa(Pc,this.K));this.m={};this.T=this.ca=this.l=this.la=this.h=null;this.S=!1;this.o=this.G=null;this.ea={};this.Fa=["onReady"];this.ka=null;this.va=NaN;this.Z={};this.j=d;Pl(this);this.fa("WATCH_LATER_VIDEO_ADDED",this.ab.bind(this));this.fa("WATCH_LATER_VIDEO_REMOVED",this.bb.bind(this));this.fa("onAdAnnounce",this.Ha.bind(this));this.Ga=new Hl(this);Rc(this,Sa(Pc,
this.Ga));this.aa=0;c?this.aa=Q(function(){e.loadNewVideoConfig(c)},0):d&&(Ql(this),Rl(this))}
...
function Pl(a){a.B=!1;if(a.ba)for(var b in a.m)a.ba(b,a.m[b]);for(var c in a.Z)Pf(parseInt(c,10));a.Z={};a.I=null;a.ba=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.fa.bind(a);a.api.removeEventListener=a.hb.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Na.bind(a);a.api.getPlayerType=a.Oa.bind(a);a.api.getCurrentVideoConfig=a.Ma.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Ea.bind(a)}
m.Ea=function(){return this.B};
m.fa=function(a,b){var c=this,d=Sl(this,b);if(d){if(!(0<=Ya(this.Fa,a)||this.m[a])){var e=cm(this,a);this.I&&this.I(a,e)}this.K.subscribe(a,d);"onReady"==a&&this.B&&Q(function(){d(c.api)},0)}};
m.hb=function(a,b){if(!this.i){var c=Sl(this,b);c&&cf(this.K,a,c)}};
...
jb(a.Z,String(e))};
return c}
m.Ha=function(a){Tg("a11y-announce",a)};
m.ab=function(a){Tg("WATCH_LATER_VIDEO_ADDED",a)};
m.bb=function(a){Tg("WATCH_LATER_VIDEO_REMOVED",a)};
m.Oa=function(){return this.T||(Vl(this)?"html5":null)};
m.Na=function(){return this.ka};
